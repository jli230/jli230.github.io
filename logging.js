...
function sendNetworkLog(
    ...
    state,
    version) {
  var formid = "1opKrLcacKjccaVCC_lwf1FAD8-GHUDuevC9kikCo91I";
  var data = {
    "entry.1178613472": uid,
    "entry.379502969": time,
    "entry.1580149426": name,
    "entry.451609564": target,
    "entry.1347337199": info,
    "entry.2025472379": state,
    "entry.1684027364": version
  };
  var params = [];
  for (key in data) {
